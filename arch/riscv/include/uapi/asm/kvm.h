...
#define KVM_DEV_RISCV_GENIRQ_GRP_DEVICE		1
#define KVM_DEV_RISCV_GENIRQ_DEV_ADDR		0
#define KVM_DEV_RISCV_GENIRQ_DEV_SIZE		1
#define KVM_DEV_RISCV_GENIRQ_DEV_IRQ		2
#define KVM_DEV_RISCV_GENIRQ_GRP_BACKING		2
#define KVM_DEV_RISCV_GENIRQ_BACKING_ADDR		0
#define KVM_DEV_RISCV_GENIRQ_BACKING_SIZE		1
#define KVM_DEV_RISCV_GENIRQ_GRP_CTRL		3
#define KVM_DEV_RISCV_GENIRQ_CTRL_INIT		0
