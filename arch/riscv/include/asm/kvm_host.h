...
struct kvm_vcpu_mmode {
	...
	unsigned long sstateen1;
	unsigned long sstateen2;
	unsigned long sstateen3;
	unsigned long hstatus;
	unsigned long hcounteren;
	unsigned long hedeleg;
	unsigned long hideleg;
