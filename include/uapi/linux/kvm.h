...
#define KVM_CAP_RISCV_M_MODE 245
#define KVM_CAP_RISCV_NESTED 246
...
#define KVM_DEV_TYPE_MY_DEBUG_PRINT	KVM_DEV_TYPE_MY_DEBUG_PRINT
	KVM_DEV_TYPE_MY_VIRTIO_GENIRQ,
#define KVM_DEV_TYPE_MY_VIRTIO_GENIRQ	KVM_DEV_TYPE_MY_VIRTIO_GENIRQ
